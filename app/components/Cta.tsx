  ...
  return (
    <section id="cta" className="py-28 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[900px] h-[450px] rounded-full bg-primary/7 blur-[110px]" />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
          Find your perfect
          <br />
          <span className="text-primary">tandem mate</span> today
        </h2>
